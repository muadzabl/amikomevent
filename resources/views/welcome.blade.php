    ...
    <section class="max-w-7xl mx-auto px-6 py-12">
        ...
        <div class="flex flex-wrap gap-3">
            @foreach ($categories as $category)
                <button class="px-5 py-2.5 bg-white border-2 border-slate-100 rounded-2xl font-bold text-sm hover:border-indigo-600 hover:text-indigo-600 shadow-sm transition">
                    {{ $category->name }}
                </button>
            @endforeach
        </div>
